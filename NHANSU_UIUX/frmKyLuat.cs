...
namespace NHANSU_UIUX
{
    public partial class frmKyLuat : DevExpress.XtraEditors.XtraForm
    {
        ...
        void loadData()
        {
            gvDanhSach.DataSource = _kt.getListFull(2);
        }
        void saveData()
        {
            if (_themhopdong)
            {
                ...
                kt.SOQUYETDINH = n.ToString("00000") + @"/2024/QDKL";
                //hd.NGAYBD = dtpNgayBatDau.Value;
                //hd.NGAYKT = dtpNgayKetThuc.Value;
                kt.TUNGAY = dtpTuNgay.Value;
                kt.DENNGAY = dtpDenNgay.Value;
                kt.LOAI = 2;
        ...
        private void gvDanhSach_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (rowIndex >= 0 && rowIndex < gvDanhSach.Rows.Count)
            {
                ...
                dtpTuNgay.Value = kt.TUNGAY.Value;
                dtpDenNgay.Value = kt.DENNGAY.Value;
